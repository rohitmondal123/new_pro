  ...
  const [taskHistory, setTaskHistory] = useState<WorkTask[]>([
    {
      ...
      sender: 'bot',
      type: 'chat',
      title: 'Team Drishti AI Bot',
      result:
        'Namaste! I am your automated Team Drishti AI Work Bot. You can chat with me directly, or click the directives above to run deep scans, draft inspection memos, or calculate fund risks.',
      timestamp: 'Online',
    },
  ]);
...
[Generated by Team Drishti AI Work Engine]`;
      ...
      setTaskHistory((prev) => [
        ...prev,
        {
          ...
          matchedProjects: ['MPL-1024'],
          suggestedAction: {
            label: 'View Investigation Queue',
            route: 'queue',
          },
          timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
        },
...
• High Probability Root Causes: Contractor billing ahead of physical masonry, missing inspection sign-offs.`;
  ...
  const handleCustomQuery = async (e: React.FormEvent) => {
    ...
    setIsWorking(true);
    setWorkingStatus('Team Drishti AI thinking...');
    ...
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end">
        ...
        <button
          ...
          title="Open Team Drishti AI Work Robot"
          aria-label="Open Team Drishti AI Work Robot"
        >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-bold text-xs tracking-wide">DRISHTI WORK BOT</span>
